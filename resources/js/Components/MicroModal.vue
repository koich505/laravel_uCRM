...
<template>
                    ...
                    >
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                >
                                    <td
                                        class="px-4 py-3 border-gray-200 border-b-2"
                                    >
                                        <button
                                            @click="
                                                setCustomer({
    ...
    <button
        ...
        type="button"
        class="flex mx-auto mt-2 text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg"
